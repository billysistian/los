...
$page_title = "Edit Permohonan Kredit";
                ...
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_ao" value="<?php echo $data['nama_ao'];?>" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="kode_ao" value="<?php echo $data['kode_ao'];?>" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama_identitas" value="<?php echo $data['nama_identitas'];?>" class="form-control" required disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label>Tempat :</label>
                                                <input type="text" name="tempat" value="<?php echo $data['tempat'];?>" required disabled class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label>Tanggal Lahir :</label>
                                                <input type="date" name="tanggal_lahir" max="<?php echo date('Y-m-d'); ?>" value="<?php echo $data['tanggal_lahir'];?>" required disabled class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="alamat_ktp" name="alamat_ktp" value="<?php echo $data['alamat_ktp'];?>" required disabled class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="alamat_domisili" name="alamat_domisili" value="<?php echo $data['alamat_domisili'];?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama_gadis_ibu_kandung" value="<?php echo $data['nama_gadis_ibu_kandung'];?>" required disabled autocomplete="off" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="nama_perusahaan" class="form-control" value="<?php echo $data['nama_perusahaan'];?>" required disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label>Jabatan :</label>
                                                        <input type="text" name="jabatan" class="form-control" value="<?php echo $data['jabatan'];?>" required disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label>Bidang Usaha :</label>
                                                        <input type="text" name="bidang_usaha" class="form-control" value="<?php echo $data['bidang_usaha'];?>" required disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label>Alamat Tempat Bekerja/Usaha :</label>
                                                        <input type="text" name="alamat_tempat_bekerja" class="form-control" value="<?php echo $data['alamat_tempat_bekerja'];?>" required disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label>Lama Bekerja/Berwirausaha :</label>
                                                        <input type="text" name="lama_bekerja" class="form-control" value="<?php echo $data['lama_bekerja'];?>" required disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label>Nama :</label>
                                                        <input type="text" name="nama_keluarga" class="form-control" value="<?php echo $data['nama_keluarga'];?>" required disabled>
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="hubungan_keluarga" class="form-control" value="<?php echo $data['hubungan_keluarga'];?>" required disabled>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label>Alamat :</label>
                                                        <input type="text" name="alamat_keluarga" class="form-control" value="<?php echo $data['alamat_keluarga'];?>" required disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    <label>Nama Perusahaan / Usaha :</label>
                                                    <input type="text" name="nama_perusahaan_pasangan" class="form-control pasangan" autocomplete="off" value="<?php echo $data['nama_perusahaan_pasangan'];?>" required disabled>
                                                </div>
                                                <div class="mb-3">
                                                    <label>Jabatan :</label>
                                                    <input type="text" name="jabatan_pasangan" class="form-control pasangan" autocomplete="off" value="<?php echo $data['jabatan_pasangan'];?>" required disabled>
                                                </div>
                                                <div class="mb-3">
                                                    <label>Bidang Usaha :</label>
                                                    <input type="text" name="bidang_usaha_pasangan" class="form-control pasangan" autocomplete="off" value="<?php echo $data['bidang_usaha_pasangan'];?>" required disabled>
                                                </div>
                                                <div class="mb-3">
                                                    <label>Alamat Tempat Bekerja / Usaha :</label>
                                                    <input type="text" name="alamat_tempat_bekerja_pasangan" class="form-control pasangan" autocomplete="off" value="<?php echo $data['alamat_tempat_bekerja_pasangan'];?>" required disabled>
                                                </div>
                                                <div class="mb-3">
                                                    <label>Lama Bekerja / Berwirausaha :</label>
                                                    <input type="text" name="lama_bekerja_pasangan" class="form-control pasangan" autocomplete="off" value="<?php echo $data['lama_bekerja_pasangan'];?>" required disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="badan">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="nama_pengurus_berwenang" class="form-control" autocomplete="off" value="<?php echo $data['nama_pengurus_berwenang'];?>" required disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="nama_akta_usaha" class="form-control" autocomplete="off" value="<?php echo $data['nama_akta_usaha'];?>" required disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3">
                                            <label>Bidang Usaha :</label>
                                            <input type="text" name="bidang_usaha_badan" class="form-control" autocomplete="off" value="<?php echo $data['bidang_usaha_badan'];?>" required disabled>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label>Tempat :</label>
                                                    <input type="text" name="tempat_usaha" class="form-control" autocomplete="off" value="<?php echo $data['tempat_usaha'];?>" required disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label>Tanggal Pendirian :</label>
                                                    <input type="date" name="tanggal_pendirian" max="<?php echo date('Y-m-d'); ?>" class="form-control" value="<?php echo $data['tanggal_pendirian'];?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="alamat_kantor_usaha" value="<?php echo $data['alamat_kantor_usaha'];?>" autocomplete="off" class="form-control" required disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label>Kode Pos :</label>
                                                    <input type="text" name="kode_pos_alamat_usaha" class="form-control" value="<?php echo $data['kode_pos_alamat_usaha'];?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <input
                                                    type="text"
                                                    oninput="this.setCustomValidity(''); this.value=this.value.replace(/[^0-9]/g,'')"
                                                    name="hp_pic" value="<?php echo $data['hp_pic'];?>"
                                                    class="form-control"
                                                    autocomplete="off"
                                                    required
                                                    disabled>
                                    ...
                                    <div id="list-agunan">
                                        ...
                                        <div class="row mb-3 agunan-item">
                                            <div class="col-md-2">
                                                ...
                                                <select 
                                                name="jenis_agunan[]" 
                                                class="form-control jenis-agunan" required>
                                            ...
                                            <div class="col-md-9 field-agunan">

                                            <?php if($a['jenis_agunan']=="shm" || $a['jenis_agunan']=="shgb" || $a['jenis_agunan']=="shmsrs"){ ?>
                                                <input type="hidden" name="id_agunan[]" value="<?= $a['id'] ?>">
                                                <div class="row">
                                                    <div class="col-md-4">
                        ...
                        <div class="card-action">
                            <button type="button" id="update" class="btn btn-primary"><i class="fas fa-paper-plane"></i> Simpan Perubahan</button>
    ...
    $(document).ready(function(){
        function tampilForm(){
            ...
            if(jenis=="perorangan"){
                $("#perorangan").show();
                $("#badan").hide();
                $("#badan").find("input, select, textarea").attr("disabled", true);
                $("#perorangan").find("input, select, textarea").removeAttr("disabled").attr("autocomplete","off");
            }
            else if(jenis=="badan_usaha"){
                $("#badan").show();
                $("#perorangan").hide();
                $("#perorangan").find("input, select, textarea").attr("disabled", true);
                $("#badan").find("input, select, textarea").removeAttr("disabled").attr("autocomplete","off");
            }
            else{
                $("#perorangan").hide();
                $("#badan").hide();
                $("#perorangan, #badan").find("input, select, textarea").attr("disabled", true);
            }
        }
        tampilForm();
